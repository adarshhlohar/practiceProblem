...
class CustomerSortingComparator implements Comparator<Person>{
	...
	public int compare(Person o1, Person o2) {
		...
		Integer ageCompare = o1.getRollNo().compareTo(o2.getRollNo());
...
public class StudentCompareNameAndRollNo {
	...
	public static void main(String[] args) {
		List<Person> studs = Arrays.asList(new Person("Adarsh", 21), new Person("Mahesh", 22),
				new Person("Dhiraj", 24), new Person("Adarsh", 25), new Person("Mahesh", 23),
				new Person("Sachin", 26));
